          ...
          {data
            ...
            .map((visitor, index) => (
              <tr className="text-[9px] lg:text-[14px]" key={index}>
                <td className="py-2 px-2 lg:px-4 border-b">{visitor.date}</td>
                <td className="py-2 px-2 lg:px-4 border-b">
                  {visitor.customerId}
                </td>
                <td className="py-2 px-2 lg:px-4 border-b">{visitor.name}</td>
                <td className="py-2 px-2 lg:px-4 border-b">{visitor.email}</td>
                <td className="py-2 px-2 lg:px-4 border-b">{visitor.mobile}</td>
                <td className="py-2 px-2 lg:px-4 border-b">
                  {visitor.projectName}
                </td>
